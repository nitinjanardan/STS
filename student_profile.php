<?php include 'header_student.php' ?>
	<body>
		<center><h2><b>Edit Profile For Student</b></h2></center>
		<form id="contacts-form" action="database.php" method ="POST" enctype="multipart/form-data">
			<fieldset style="margin-left:300px">
				...
				<br />
				<div class = "field">
				<input type="submit" name ="epsupdate" value ="Update" style = "height:30px;width:70px;color:black;margin-left:300px">
				<a href = "student_change_password.php" style = "margin-left:80px"> Change Password </a>
				</div>
			</fieldset>
		</form>
	</body>
