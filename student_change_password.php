<?php include 'header_student.php' ?>
	<body>
		<center><h2><b>Changing Password For Student</b></h2></center>
		<form id="contacts-form" action="database.php" method ="POST" enctype="multipart/form-data">
			<fieldset style="margin-left:300px">
				...
				<br />
				<div class = "field">
				<center><input type="submit" name ="stupdate" value ="Update" style = "height:30px;width:70px;color:black;"></center>
				</div>
			</fieldset>
		</form>
	</body>
